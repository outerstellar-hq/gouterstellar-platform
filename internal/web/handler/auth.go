...
func (h *AuthHandler) ShowLogin(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.renderer.Render(w, r, "auth_login.html", page); err != nil {
...
func (h *AuthHandler) ShowChangePassword(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.renderer.Render(w, r, "auth_change_password.html", page); err != nil {
		http.Error(w, "Template error", http.StatusInternalServerError)
	}
}
...
func (h *AuthHandler) ShowResetPassword(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.renderer.Render(w, r, "auth_reset_password.html", page); err != nil {
		http.Error(w, "Template error", http.StatusInternalServerError)
	}
}
...
func (h *AuthHandler) HandleResetPassword(w http.ResponseWriter, r *http.Request) {
	...
	_ = h.renderer.Render(w, r, "auth_reset_sent.html", viewmodel.AuthPage{
		CSRFToken: web.CSRFTokenFromRequest(r),
	})
}
...
func (h *AuthHandler) renderAuthError(w http.ResponseWriter, r *http.Request, errMsg string) {
	...
	_ = h.renderer.RenderWithStatus(w, r, "auth_login.html", page, http.StatusBadRequest)
}
...
func (h *AuthHandler) renderChangePasswordError(w http.ResponseWriter, r *http.Request, errMsg string) {
	...
	_ = h.renderer.RenderWithStatus(w, r, "auth_change_password.html", page, http.StatusBadRequest)
}
...
func (h *AuthHandler) renderResetPasswordError(w http.ResponseWriter, r *http.Request, errMsg string) {
	...
	_ = h.renderer.RenderWithStatus(w, r, "auth_reset_password.html", page, http.StatusBadRequest)
}
